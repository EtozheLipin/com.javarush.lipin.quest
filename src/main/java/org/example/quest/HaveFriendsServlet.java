...
@WebServlet("/have-friends-servlet")
public class HaveFriendsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        out.println("<h2>У вас есть друзья?</h2>");
        out.println("<form method='get' action='have-friends-servlet'>");
