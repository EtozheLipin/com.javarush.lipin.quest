...
@WebServlet("/have-legs-servlet")
public class HaveLegsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        out.println("<h2>А они вам нужны?</h2>");
        out.println("<form method='get' action='have-legs-servlet'>");
